...
#define SPI_SEND_8_BIT(val) HAL_SPI_Transmit(&hspi1, (uint8_t*)val, 1, 10);
#define SPI_RECEIVE_8_BIT  HAL_SPI_TransmitReceive(&hspi1, (uint8_t*) 1, (uint8_t *)spiRecBuf, 1, 5);
